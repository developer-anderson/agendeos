        ...
        <div class="container py-5">
            <div class="row" id="step0">
                <div class="col-sm-12 text-center">
                    ...
                    <p class="mb-5">Com apenas 4 passos, você agenda o seu serviço na AgendOS - Agendamento de
                        Serviços.</p>
                    <a href="#" class="btn-button btn-primary" id="quero-agendar"><i class="fa fa-calendar"></i>
                        Quero Agendar!</a>
                </div>
            </div>
            ...
            <div class="row justify-content-center steps" id="step1">
                ...
                <div class="col-sm-12">
                    <ul class="lista-de-profissionais">
                        @foreach($funcionarios as $funcionario)
                            <li>
                                <a href="#" data-id="{{ $funcionario->id }}" data-nome="{{ $funcionario->nome }}">
                                    <figure>
            ...
            <!-- step 2 -->
            <div class="row justify-content-center steps" id="step2">
                <div class="col-sm-8">
                    <div class="steps-header">
                        <div class="number active">
                            <span class="btn-step1">1</span>
                ...
                <div class="col-sm-12">
                    <ul class="lista-de-servicos">
                                   ...
                                   <li>
                            <a href="#" data-servico="{{ $servico->id }}" data-preco="{{ $servico->valor }}" data-titulo="{{ $servico->nome }}">
                                <figure>
                                    <img src="https://placehold.it/80x80" alt="">
                                </figure>
                                <span class="title-profissional">{{ $servico->nome }} - <b>R$ {{ number_format(($servico->valor/100), 2, ",", ".") }}</b></span>
                                <span class="btn btn-primary">Selecionar</span>
                            </a>
                        </li>
                        @endforeach
                    ...
                    <div class="subtotal col-sm-12 text-center">
                        <span>Subtotal</span>
                        <h1 class="total-price">R$ 0,00</h1>
                    </div>

                    <div class="col-sm-12 py-5 text-center">
                        <a href="#" class="btn-button btn-primary btn-next" id="escolher-data"><i class="fa fa-calendar"></i> Escolher Data</a>
                    </div>
                </div>
            ...
            <div class="row justify-content-center steps" id="step3">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-12 py-5 text-center">
                        <a href="#" class="btn-button btn-primary btn-next" id="btn-step4"><i class="fa fa-check"></i>
                            Finalizar</a>
                    </div>
                </div>
                    ...
                    <div class="form data">
                        <form id="formulario">
                            ...
                            <div class="form-group">
                                ...
                                <input name="whatsapp" type="tel" class="form-control" id="whatsapp" pattern="\([0-9]{2}\) [0-9]{4,6}-[0-9]{3,4}" required>
            ...
            <div class="row box-infos">
                ...
                <div class="col-sm-4">
                    <div class="card">
                        <h3>Localização</h3>
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3889.667184133234!2d-38.47784792413805!3d-12.86475975767161!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x71611d396e97eed%3A0x54d637f2f0e8e018!2sWcriarte%20-%20Cria%C3%A7%C3%A3o%20de%20Sites%20e%20Marketing%20Digital%20em%20Salvador!5e0!3m2!1spt-BR!2sbr!4v1688487061207!5m2!1spt-BR!2sbr" width="600" height="450" style="border:0; width: 100%; height: 250px" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                </div>
            </div>
        </div>
                ...
                <form id="add-event">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="data-de-nascimento" name="data-de-nascimento">
                        </div>
                        <div class="form-group">
