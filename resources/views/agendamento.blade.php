        ...
        <div style=" background-color: rgba(0, 0, 0, 0.8)"
            ...
            <div class="p-4 max-w-xl mx-auto relative absolute left-0 right-0 overflow-hidden mt-24">
                ...
                <div class="shadow w-full rounded-lg bg-white overflow-hidden w-full block p-8">
                    ...
                    <h2 class="font-bold text-2xl mb-6 text-gray-800 border-b pb-2">Realizar agendamento</h2>

                    <div class="mb-4">
                        <label class="text-gray-800 block mb-1 font-bold text-sm tracking-wide">Selecione o(s)
                            serviços</label>
                        <input
    ...
    <script>
        ...
        function app() {
            return {
                ...
                no_of_days: [],
                blankdays: [],
                days: ['Dom', 'Seg', 'Ter', 'Quar', 'Quin', 'Sex', 'Sáb'],
                events: [{
